...
****************************************************************************/
class Consensus_log_event : public binary_log::Consensus_event, public Log_event
{
public:
#ifndef MYSQL_CLIENT
  /**
  ...
  */
  Consensus_log_event(uint32 flag_arg,
...
private:
  ...
  static const size_t MAX_SET_STRING_LENGTH = SET_STRING_FLAG_LENGTH +
    SET_STRING_TERM_LENGTH + SET_STRING_INDEX_LENGTH + SET_STRING_LENGTH_LENGTH + SET_STRING_RESERVE_LENGTH +
    18U + 36U + 36U + 36U + 36U;
};
...
****************************************************************************/
class Consensus_cluster_info_log_event : public binary_log::Consensus_cluster_info_event, public Log_event
{
public:
#ifndef MYSQL_CLIENT
  /**
...
#endif
  Consensus_cluster_info_log_event(const char *buffer, uint event_len,
    const Format_description_event *description_event);
...
private:
  ...
  static const size_t MAX_SET_STRING_LENGTH = SET_STRING_INFO_LENGTH_LENGTH + 36U;
};

class Consensus_empty_log_event : public binary_log::Consensus_empty_event, public Log_event
{
public:
#ifndef MYSQL_CLIENT
  /**
