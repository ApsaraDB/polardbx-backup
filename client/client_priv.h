...
enum options_client {
  ...
  OPT_START_INDEX,
  OPT_STOP_INDEX,
  OPT_TRUNCATE_DATETIME,
  OPT_TRIM_TAIL_INCOMPLETE_TRX,
  OPT_APPEND_ROTATE_EVENT,
  OPT_SHOW_INDEX_INFO,
  OPT_TRUNCATE_INDEX_FROM,
  OPT_TRUNCATE_FROM_SEQUENCE_NUMBER,
  OPT_TRUNCATE_POINT_PEEK_BACKWARD,
  OPT_TRUNCATE_POINT_PEEK_FORWARD,
