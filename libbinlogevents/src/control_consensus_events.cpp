...
Consensus_event::Consensus_event(const char* buf, unsigned int event_len __attribute__((unused)),
...
Previous_consensus_index_event::Previous_consensus_index_event(const char* buf, unsigned int event_len __attribute__((unused)),
    const Format_description_event*
    description_event)
    : Binary_log_event(&buf, description_event),
    index(0) {
...
Consensus_cluster_info_event::Consensus_cluster_info_event(const char* buf, unsigned int event_len __attribute__((unused)),
  const Format_description_event*
  description_event)
  : Binary_log_event(&buf, description_event) {
  /*
...
Consensus_empty_event::Consensus_empty_event(const char* buf, unsigned int event_len __attribute__((unused)),
  const Format_description_event*
  description_event)
  : Binary_log_event(&buf, description_event) {
  /*
